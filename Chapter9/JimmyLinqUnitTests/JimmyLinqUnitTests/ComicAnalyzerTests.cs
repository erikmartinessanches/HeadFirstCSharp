namespace JimmyLinqUnitTests {
    ...
    //Hi friend, how are you fgdfgd? 
    [TestClass]
    public class ComicAnalyzerTests {
        private IEnumerable<Comic> testComics = new[] {
        ...
        /*MSTest's CollectionAssert class has static methods for comparing
         expected vs actual collection results. */
        [TestMethod]
        public void ComicAnalyzer_Should_Generate_A_List_Of_Reviews() {
            var testReviews = new[] {
                new Review() {
                    Issue = 1, Critic = Critics.MuddyCritic, Score = 14.5
                },
                new Review() {
                    Issue = 1, Critic = Critics.RottenTornadoes, Score = 59.93
                },
                new Review() {
                    Issue = 2, Critic = Critics.MuddyCritic, Score = 40.3
                },
                new Review() {
                    Issue = 2, Critic = Critics.RottenTornadoes, Score = 95.11
                }
            };
            ...
            var actualResults = ComicAnalyzer
                .GetReviews(testComics, testReviews).ToList();
        ...
        public void ComicAnalyzer_Should_Handle_Weird_Review_Scores() {
            var testReviews = new[] {
                new Review() {
                    Issue = 1, Critic = Critics.MuddyCritic, Score = -12.1212
                },
                new Review() {
                    Issue = 1,
                    Critic = Critics.RottenTornadoes,
                    Score = 391691234.48931
                },
                new Review() {
                    Issue = 2, Critic = Critics.RottenTornadoes, Score = 0
                },
                new Review() {
                    Issue = 2, Critic = Critics.MuddyCritic, Score = 40.3
                },
